                  ...
                  <teleport to="#modifyArticles">
                    <div v-if="modalModifyPost" class="modal">
                      <div class="card rounded mx-auto col-12 col-md-8">
                        <div class="card-body bg-light">
                          <div class="card-header rounded mb-3 position-relative">
                            <span class="card-title rounded-pill p-2 fw-bold"><font-awesome-icon icon="user"/>
                          ...
                          <div class="mt-3 card-buttons d-flex justify-content-between">
                            <button type="button" v-on:click="modalModifyPost = false" class="btn-close" aria-label="Annuler"></button>   
                            <button class="btn btn-primary rounded-pill" type="submit">Valider</button>
                          </div>
                          </div>
                        </div>
                      </div>
